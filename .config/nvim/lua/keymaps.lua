...
map('n', '<Leader><Leader>f', ':Telescope find_files<CR>', default_opts)
map('n', '<Leader><Leader>g', ':Telescope git_commits<CR>', default_opts)
map('n', '<Leader><Leader>k', ':TodoTelescope<CR>', default_opts)
map('n', '<Leader><Leader>l', ':Telescope live_grep<CR>', default_opts)
map('n', '<Leader><Leader>d', ':Trouble<CR>', default_opts)
